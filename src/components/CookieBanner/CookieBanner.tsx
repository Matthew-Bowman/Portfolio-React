...
const consentExpired = (timestamp: number) =>
  Date.now() - timestamp > SIX_MONTHS_MS;
...
export const CookieBanner: FC<CookieBannerProps> = ({ onAccept, onReject }) => {
      ...
      <div className="card shadow">
        <div className="card-body d-flex flex-column flex-md-row align-items-center justify-content-between">
          <div className="mb-3 mb-md-0">
            <strong>We use cookies</strong> to improve your experience on this
            site. By accepting, you agree to our use of cookies.{" "}
